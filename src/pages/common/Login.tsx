        ...
        {!selected ? (
          <>
            ...
            <p className="text-xs text-center text-gray-500 mt-6">
              ...
              <span onClick={() => navigate("/register")} className="text-[#00296B] font-medium cursor-pointer hover:underline">
                Créer un compte
              </span>
            </p>
          </>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input type="email" placeholder="exemple@mail.com" className="border border-gray-200 rounded-lg px-4 py-2 text-sm focus:outline-none focus:border-[#FFC300]" />
            </div>

            <div className="flex flex-col gap-1">
              <label className="text-xs text-gray-500">Mot de passe</label>
              <input type="password" placeholder="••••••••" className="border border-gray-200 rounded-lg px-4 py-2 text-sm focus:outline-none focus:border-[#FFC300]" />
            </div>
